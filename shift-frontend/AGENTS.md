...
A plataforma Shift tem como objetivo central eliminar o trabalho manual e propenso a erros nas migrações de dados. O coração dessa proposta de valor é o Template Builder e o Mapeador Central (Comunidade).

Em vez de apenas "configurar uma migração", a plataforma Shift foca na reutilização de conhecimento.
...
Todos os arquivos de exemplo do design-system encontram-se na pasta 
...
```
ATENÇÃO ESSA PASTA SERVE APENAS COMO REFERÊNCIA, NÃO É NECESSÁRIO QUE AS COISAS FUNCIONEM NELA.
---
