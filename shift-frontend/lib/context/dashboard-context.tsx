...
export function DashboardProvider({ children }: { children: React.ReactNode }) {
  ...
  async function reloadOrganizations(preferredOrgId?: string | null) {
    ...
    setOrganizations(orgs as OrganizationWithRole[])
  ...
  async function createOrganizationAndSelect(payload: { name: string; slug: string }) {
    const created = await createOrganization({ name: payload.name, slug: payload.slug })
