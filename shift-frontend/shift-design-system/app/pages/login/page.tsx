      ...
      <div className="relative z-10 w-full max-w-sm px-4">
        ...
        <div className="mb-8 flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            <h1 className="text-xl font-semibold text-white">Sign in to Acme</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="mb-1.5 flex items-center justify-between">
              ...
              <Link href="#" className="text-xs text-neutral-500 transition-colors hover:text-white">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="mt-6 text-center text-xs text-neutral-600">
          ...
          <Link href="#" className="text-neutral-400 underline-offset-4 transition-colors hover:text-white hover:underline">
            Create one
          </Link>
        </p>
